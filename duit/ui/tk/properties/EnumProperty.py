...
class EnumProperty(OptionsProperty):
    """
    Property class for handling enum-based fields in a Tkinter-based UI.

    This property displays an enum field in a Tkinter UI, allowing the user to select from a list of predefined options.
